<template>
  <v-app>
    <v-content>
      <v-container class="fill-height" mt-11 fluid>
            ...
            <v-card>
              <v-row>
                ...
                <v-col cols="6" md="6" style="padding: 0px;">
                  <v-img
                    :src="require('@/assets/scene_05_-_door_dribbble.gif')"
                    width="425px"
                    height="545px"
                  ></v-img>
                </v-col>
...
export default {
  data() {
    return {
      ...
      NIPRules: [(v) => !!v || "Nama Pegawai harus dimasukkan"],
        ...
        this.$http
          ...
          .then((response) => {
            ...
            if (this.pegawais.stat.toLowerCase() == "customer service") {
              ...
              // );
              sessionStorage.setItem("Nama", response.data.message.NIP);
              this.snackbar = true;
              this.text = "Login Berhasil";
              this.color = "green";
