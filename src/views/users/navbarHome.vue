  ...
  export default {
    data () {
      return {
        ...
        { icon:'mdi mdi-cash-multiple', title: 'Pembayaran Layanan Kasir', route: '/views/users/pembayaranLayananKasir' },
        { icon:'mdi mdi-cash-multiple', title: 'Pembayaran Produk Kasir', route: '/views/users/pembayaranProdukKasir' },
