    ...
    methods: {
      ...
      getData() {
       ...
       getColor (items,index) {
        ...
        if (items[index].jumlah_stok < items[index].min_stok_produk) return 'red'
        else if (  items[index].jumlah_stok > items[index].min_stok && items[index].stok_produk < this.temp[index]) return 'orange' 
        else return 'green'
      },
