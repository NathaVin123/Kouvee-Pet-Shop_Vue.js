    ...
    <v-row>
      ...
      <v-col cols="12">
        ...
        <v-card>
          ...
          <div class="pa-5">
            <h2 class="subheading grey-darken--text">Proses Pengadaan Produk</h2>
              ...
              <template v-slot:body="{ items }">
                <tbody>
                  <tr v-for="(item, index) in items" :key="item.no_order">
                    ...
                    <td>
                      <div>
                        <v-btn color="blue darken-1" icon @click="updatePengadaanSelesai(item)">
        ...
        <v-card>
          ...
          <v-card-text>
            ...
            <v-simple-table height="50%">
              ...
              <tbody>
                <tr v-for="item in filteredItems2(detailItem)" :key="item.no_order">
